#!/usr/bin/env node
/**
 * @author: Anand Gupta<aanand.gupta03@gmail.com>
 */
...
console.log(
  chalk.yellow(
    figlet.textSync('jsx-parser', { horizontalLayout: 'default' })
  )
);
...
var entryFile = args.e || 'index.tsx';
      ...
      if (caseName.endsWith('.js')) {
        ...
        transformed = babel.transformFileSync(
          path.join(basePath, caseName), {
            presets: ["es2015"],
            plugins: [
              "babel-plugin-jsx-element-stripper"
            ]
          }
        ).code;
